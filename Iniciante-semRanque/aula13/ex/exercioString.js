...
document.body.innerHTML += `Qual o último índice da letra LETRA no seu nome: <strong> ${nome.lastIndexOf('')} </strong> <br />`
...
console.log(nome.replace(/ /g, '').length, nome.charAt(28))